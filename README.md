...
Sistema de tarefas com automação da descrição da tarefa usando a API Gemini.
...
existem dois tipos de bancos de dados: relacionados (mysql) e não relacionais ( REDIS ).
